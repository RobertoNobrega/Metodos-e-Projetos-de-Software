...
/**
 *
 * @authors Carlos Alberto Nunes da Silva - Matr. 11398177 Roberto Freire da
 * Nóbrega - 11228219
 */
import Business.Control.ControlCliente;
import Business.Control.ControlUsuario;
...
public class UsuarioForm_Cadastrar extends javax.swing.JFrame {
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        try {
            ...
            if (senha.equals(senhaConfirmada)) {
                ...
                UsuarioForm_Acessar usa = new UsuarioForm_Acessar();
                usa.setVisible(true);
            } else {

...
public class MensagemForm extends javax.swing.JFrame {
    ...
    ControlEnviarMensagem control;

    public MensagemForm() {
        initComponents();
        control = new ControlEnviarMensagem();
    }
    ...
    private void initComponents() {
        ...
        jCheckBoxEmail.setText("E-mail");

        jCheckBoxSMS.setText("SMS");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jTextFieldMensagem, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // capturar as mensagens e os botões
        String mensagem = jTextFieldMensagem.getText();

        if (jCheckBoxEmail.isSelected()) {
            control.enviarMensagemEmail(mensagem, "roberto@gamail.com");
        }

        if (jCheckBoxSMS.isSelected()) {
            control.enviarMensagemSMS(mensagem, "987679231");
        }

        if (jCheckBoxWhatsapp.isSelected()) {
            control.enviarMensagemWhatsApp(mensagem, "987679231");
        }
